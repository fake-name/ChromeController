from ChromeController.transport import ChromeSocketManager
...
class ChromeRemoteDebugInterface(ChromeInterface):
	...
	def Memory_setPressureNotificationsSuppressed(self, suppressed):
		...
		assert isinstance(suppressed, (bool,)
		    ), 'Argument suppressed must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    suppressed)
	...
	def Page_addScriptToEvaluateOnLoad(self, scriptSource):
		...
		assert isinstance(scriptSource, (str,)
		    ), 'Argument scriptSource must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    scriptSource)
	...
	def Page_setAutoAttachToCreatedPages(self, autoAttach):
		...
		assert isinstance(autoAttach, (bool,)
		    ), 'Argument autoAttach must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    autoAttach)
	...
	def Page_reload(self, **kwargs):
		...
		if 'ignoreCache' in kwargs:
			assert isinstance(kwargs['ignoreCache'], (bool,)
			    ), "Argument ignoreCache must be of type (['bool']). Received type: %s" % type(
			    kwargs['ignoreCache'])
		if 'scriptToEvaluateOnLoad' in kwargs:
			assert isinstance(kwargs['scriptToEvaluateOnLoad'], (str,)
			    ), "Argument scriptToEvaluateOnLoad must be of type (['str']). Received type: %s" % type(
	...
	def Page_navigate(self, url, **kwargs):
		...
		assert isinstance(url, (str,)
		    ), 'Argument url must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    url)
		if 'referrer' in kwargs:
			assert isinstance(kwargs['referrer'], (str,)
			    ), "Argument referrer must be of type (['str']). Received type: %s" % type(
			    kwargs['referrer'])
		expected = ['referrer']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
		    ), "Allowed kwargs are ['referrer']. Passed kwargs: %s" % passed_keys
	...
	def Page_navigateToHistoryEntry(self, entryId):
		...
		assert isinstance(entryId, (int,)
		    ), 'Argument entryId must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    entryId)
	...
	def Page_deleteCookie(self, cookieName, url):
		...
		assert isinstance(cookieName, (str,)
		    ), 'Argument cookieName must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    cookieName)
		assert isinstance(url, (str,)
		    ), 'Argument url must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    url)
	...
	def Page_searchInResource(self, frameId, url, query, **kwargs):
		...
		assert isinstance(query, (str,)
		    ), 'Argument query must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    query)
		if 'caseSensitive' in kwargs:
			assert isinstance(kwargs['caseSensitive'], (bool,)
			    ), "Argument caseSensitive must be of type (['bool']). Received type: %s" % type(
			    kwargs['caseSensitive'])
		if 'isRegex' in kwargs:
			assert isinstance(kwargs['isRegex'], (bool,)
			    ), "Argument isRegex must be of type (['bool']). Received type: %s" % type(
			    kwargs['isRegex'])
	...
	def Page_setDocumentContent(self, frameId, html):
		...
		assert isinstance(html, (str,)
		    ), 'Argument html must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    html)
	...
	def Page_setDeviceMetricsOverride(self, width, height, deviceScaleFactor,
		...
		Function path: Page.setDeviceMetricsOverride
			...
			Parameters:
				Required arguments:
					...
					'fitWindow' (type: boolean) -> Whether a view that exceeds the available browser window area should be scaled down to fit.
				Optional arguments:
					'scale' (type: number) -> Scale to apply to resulting view image. Ignored in |fitWindow| mode.
					'offsetX' (type: number) -> X offset to shift resulting view image by. Ignored in |fitWindow| mode.
					'offsetY' (type: number) -> Y offset to shift resulting view image by. Ignored in |fitWindow| mode.
					'screenWidth' (type: integer) -> Overriding screen width value in pixels (minimum 0, maximum 10000000). Only used for |mobile==true|.
					'screenHeight' (type: integer) -> Overriding screen height value in pixels (minimum 0, maximum 10000000). Only used for |mobile==true|.
					'positionX' (type: integer) -> Overriding view X position on screen in pixels (minimum 0, maximum 10000000). Only used for |mobile==true|.
					'positionY' (type: integer) -> Overriding view Y position on screen in pixels (minimum 0, maximum 10000000). Only used for |mobile==true|.
		...
		assert isinstance(width, (int,)
		    ), 'Argument width must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    width)
		assert isinstance(height, (int,)
		    ), 'Argument height must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    height)
		assert isinstance(deviceScaleFactor, (float, int)
		    ), 'Argument deviceScaleFactor must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    deviceScaleFactor)
		assert isinstance(mobile, (bool,)
		    ), 'Argument mobile must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    mobile)
		assert isinstance(fitWindow, (bool,)
		    ), 'Argument fitWindow must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    fitWindow)
		if 'scale' in kwargs:
			assert isinstance(kwargs['scale'], (float, int)
			    ), "Argument scale must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['scale'])
		if 'offsetX' in kwargs:
			assert isinstance(kwargs['offsetX'], (float, int)
			    ), "Argument offsetX must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['offsetX'])
		if 'offsetY' in kwargs:
			assert isinstance(kwargs['offsetY'], (float, int)
			    ), "Argument offsetY must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['offsetY'])
		if 'screenWidth' in kwargs:
			assert isinstance(kwargs['screenWidth'], (int,)
			    ), "Argument screenWidth must be of type (['int']). Received type: %s" % type(
			    kwargs['screenWidth'])
		if 'screenHeight' in kwargs:
			assert isinstance(kwargs['screenHeight'], (int,)
			    ), "Argument screenHeight must be of type (['int']). Received type: %s" % type(
			    kwargs['screenHeight'])
		if 'positionX' in kwargs:
			assert isinstance(kwargs['positionX'], (int,)
			    ), "Argument positionX must be of type (['int']). Received type: %s" % type(
			    kwargs['positionX'])
		if 'positionY' in kwargs:
			assert isinstance(kwargs['positionY'], (int,)
			    ), "Argument positionY must be of type (['int']). Received type: %s" % type(
			    kwargs['positionY'])
		expected = ['scale', 'offsetX', 'offsetY', 'screenWidth', 'screenHeight',
		    'positionX', 'positionY', 'screenOrientation']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
		    ), "Allowed kwargs are ['scale', 'offsetX', 'offsetY', 'screenWidth', 'screenHeight', 'positionX', 'positionY', 'screenOrientation']. Passed kwargs: %s" % passed_keys
		subdom_funcs = self.synchronous_command('Page.setDeviceMetricsOverride',
		    ...
		    mobile=mobile, fitWindow=fitWindow, **kwargs)
		return subdom_funcs
	...
	def Page_setGeolocationOverride(self, **kwargs):
		...
		if 'latitude' in kwargs:
			assert isinstance(kwargs['latitude'], (float, int)
			    ), "Argument latitude must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['latitude'])
		if 'longitude' in kwargs:
			assert isinstance(kwargs['longitude'], (float, int)
			    ), "Argument longitude must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['longitude'])
		if 'accuracy' in kwargs:
			assert isinstance(kwargs['accuracy'], (float, int)
			    ), "Argument accuracy must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['accuracy'])
	...
	def Page_setDeviceOrientationOverride(self, alpha, beta, gamma):
		...
		assert isinstance(alpha, (float, int)
		    ), 'Argument alpha must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    alpha)
		assert isinstance(beta, (float, int)
		    ), 'Argument beta must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    beta)
		assert isinstance(gamma, (float, int)
		    ), 'Argument gamma must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    gamma)
	...
	def Page_setTouchEmulationEnabled(self, enabled, **kwargs):
		...
		assert isinstance(enabled, (bool,)
		    ), 'Argument enabled must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    enabled)
		if 'configuration' in kwargs:
			assert isinstance(kwargs['configuration'], (str,)
			    ), "Argument configuration must be of type (['str']). Received type: %s" % type(
	...
	def Page_captureScreenshot(self, **kwargs):
		...
		Function path: Page.captureScreenshot
			...
			Parameters:
				Optional arguments:
					...
					'fromSurface' (type: boolean) -> Capture the screenshot from the surface, rather than the view. Defaults to false.
			Returns:
		...
		if 'format' in kwargs:
			assert isinstance(kwargs['format'], (str,)
			    ), "Argument format must be of type (['str']). Received type: %s" % type(
			    kwargs['format'])
		if 'quality' in kwargs:
			assert isinstance(kwargs['quality'], (int,)
			    ), "Argument quality must be of type (['int']). Received type: %s" % type(
			    kwargs['quality'])
		if 'fromSurface' in kwargs:
			assert isinstance(kwargs['fromSurface'], (bool,)
			    ), "Argument fromSurface must be of type (['bool']). Received type: %s" % type(
			    kwargs['fromSurface'])
		expected = ['format', 'quality', 'fromSurface']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
		    ), "Allowed kwargs are ['format', 'quality', 'fromSurface']. Passed kwargs: %s" % passed_keys
		subdom_funcs = self.synchronous_command('Page.captureScreenshot', **kwargs)
		return subdom_funcs

	def Page_printToPDF(self):
		"""
		...
		"""
		subdom_funcs = self.synchronous_command('Page.printToPDF')
		return subdom_funcs
	...
	def Page_startScreencast(self, **kwargs):
		...
		if 'maxWidth' in kwargs:
			assert isinstance(kwargs['maxWidth'], (int,)
			    ), "Argument maxWidth must be of type (['int']). Received type: %s" % type(
			    kwargs['maxWidth'])
		if 'maxHeight' in kwargs:
			assert isinstance(kwargs['maxHeight'], (int,)
			    ), "Argument maxHeight must be of type (['int']). Received type: %s" % type(
			    kwargs['maxHeight'])
		if 'everyNthFrame' in kwargs:
			assert isinstance(kwargs['everyNthFrame'], (int,)
			    ), "Argument everyNthFrame must be of type (['int']). Received type: %s" % type(
	...
	def Page_screencastFrameAck(self, sessionId):
		...
		assert isinstance(sessionId, (int,)
		    ), 'Argument sessionId must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    sessionId)
	...
	def Page_handleJavaScriptDialog(self, accept, **kwargs):
		...
		assert isinstance(accept, (bool,)
		    ), 'Argument accept must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    accept)
		if 'promptText' in kwargs:
			assert isinstance(kwargs['promptText'], (str,)
			    ), "Argument promptText must be of type (['str']). Received type: %s" % type(
			    kwargs['promptText'])
		expected = ['promptText']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
	...
	def Page_setColorPickerEnabled(self, enabled):
		"""
		Function path: Page.setColorPickerEnabled
			Domain: Page
			Method name: setColorPickerEnabled
		
			WARNING: This function is marked 'Experimental'!
		
			Parameters:
				Required arguments:
					'enabled' (type: boolean) -> Shows / hides color picker
			No return value.
		...
		assert isinstance(enabled, (bool,)
		    ...
		    enabled)
		subdom_funcs = self.synchronous_command('Page.setColorPickerEnabled',
		    enabled=enabled)
		return subdom_funcs

	def Page_configureOverlay(self, **kwargs):
		"""
		Function path: Page.configureOverlay
			Domain: Page
			Method name: configureOverlay
		
			WARNING: This function is marked 'Experimental'!
		
			Parameters:
				Optional arguments:
					'suspended' (type: boolean) -> Whether overlay should be suspended and not consume any resources.
					'message' (type: string) -> Overlay message to display.
			No return value.
		
			Description: Configures overlay.
		"""
		if 'suspended' in kwargs:
			assert isinstance(kwargs['suspended'], (bool,)
		...
		if 'message' in kwargs:
			assert isinstance(kwargs['message'], (str,)
			    ...
			    kwargs['message'])
		expected = ['suspended', 'message']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
		    ), "Allowed kwargs are ['suspended', 'message']. Passed kwargs: %s" % passed_keys
		subdom_funcs = self.synchronous_command('Page.configureOverlay', **kwargs)
		return subdom_funcs
	...
	def Page_setControlNavigations(self, enabled):
		"""
		Function path: Page.setControlNavigations
			Domain: Page
			Method name: setControlNavigations
		...
		assert isinstance(enabled, (bool,)
		    ...
		    enabled)
		subdom_funcs = self.synchronous_command('Page.setControlNavigations',
		    enabled=enabled)
		return subdom_funcs

	def Page_processNavigation(self, response, navigationId):
		"""
		Function path: Page.processNavigation
			Domain: Page
			Method name: processNavigation
		
			WARNING: This function is marked 'Experimental'!
		
			Parameters:
				Required arguments:
					'response' (type: NavigationResponse) -> No description
					'navigationId' (type: integer) -> No description
			No return value.
		...
		"""
		assert isinstance(navigationId, (int,)
		    ), 'Argument navigationId must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    navigationId)
		subdom_funcs = self.synchronous_command('Page.processNavigation',
		    response=response, navigationId=navigationId)
		return subdom_funcs
	...
	def Rendering_setShowPaintRects(self, result):
		"""
		Function path: Rendering.setShowPaintRects
			Domain: Rendering
		...
		assert isinstance(result, (bool,)
		    ), 'Argument result must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    result)
		subdom_funcs = self.synchronous_command('Rendering.setShowPaintRects',
		    result=result)
		return subdom_funcs

	def Rendering_setShowDebugBorders(self, show):
		"""
		Function path: Rendering.setShowDebugBorders
			Domain: Rendering
		...
		assert isinstance(show, (bool,)
		    ), 'Argument show must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    show)
		subdom_funcs = self.synchronous_command('Rendering.setShowDebugBorders',
		    show=show)
		return subdom_funcs

	def Rendering_setShowFPSCounter(self, show):
		"""
		Function path: Rendering.setShowFPSCounter
			Domain: Rendering
		...
		assert isinstance(show, (bool,)
		    ...
		    show)
		subdom_funcs = self.synchronous_command('Rendering.setShowFPSCounter',
		    show=show)
		return subdom_funcs

	def Rendering_setShowScrollBottleneckRects(self, show):
		"""
		Function path: Rendering.setShowScrollBottleneckRects
			Domain: Rendering
		...
		assert isinstance(show, (bool,)
		    ...
		    show)
		subdom_funcs = self.synchronous_command(
		    'Rendering.setShowScrollBottleneckRects', show=show)
		return subdom_funcs

	def Rendering_setShowViewportSizeOnResize(self, show):
		"""
		Function path: Rendering.setShowViewportSizeOnResize
			Domain: Rendering
		...
		assert isinstance(show, (bool,)
		    ...
		    show)
		subdom_funcs = self.synchronous_command(
		    'Rendering.setShowViewportSizeOnResize', show=show)
		return subdom_funcs

	def Emulation_setDeviceMetricsOverride(self, width, height,
	    deviceScaleFactor, mobile, fitWindow, **kwargs):
		"""
		Function path: Emulation.setDeviceMetricsOverride
			...
			Parameters:
				...
				Optional arguments:
					'scale' (type: number) -> Scale to apply to resulting view image. Ignored in |fitWindow| mode.
					'offsetX' (type: number) -> Not used.
					'offsetY' (type: number) -> Not used.
					'screenWidth' (type: integer) -> Overriding screen width value in pixels (minimum 0, maximum 10000000). Only used for |mobile==true|.
					'screenHeight' (type: integer) -> Overriding screen height value in pixels (minimum 0, maximum 10000000). Only used for |mobile==true|.
					'positionX' (type: integer) -> Overriding view X position on screen in pixels (minimum 0, maximum 10000000). Only used for |mobile==true|.
					'positionY' (type: integer) -> Overriding view Y position on screen in pixels (minimum 0, maximum 10000000). Only used for |mobile==true|.
	...
	def Emulation_forceViewport(self, x, y, scale):
		"""
		Function path: Emulation.forceViewport
			Domain: Emulation
			Method name: forceViewport
		
			WARNING: This function is marked 'Experimental'!
		
			Parameters:
				Required arguments:
					'x' (type: number) -> X coordinate of top-left corner of the area (CSS pixels).
					'y' (type: number) -> Y coordinate of top-left corner of the area (CSS pixels).
					'scale' (type: number) -> Scale to apply to the area (relative to a page scale of 1.0).
			No return value.
		...
		assert isinstance(x, (float, int)
		    ), 'Argument x must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    x)
		assert isinstance(y, (float, int)
		    ), 'Argument y must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    y)
		assert isinstance(scale, (float, int)
		    ), 'Argument scale must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    scale)
		subdom_funcs = self.synchronous_command('Emulation.forceViewport', x=x, y
		    =y, scale=scale)
		return subdom_funcs

	def Emulation_resetViewport(self):
		"""
		Function path: Emulation.resetViewport
			Domain: Emulation
			Method name: resetViewport
		...
		"""
		subdom_funcs = self.synchronous_command('Emulation.resetViewport')
		return subdom_funcs
	...
	def Emulation_setPageScaleFactor(self, pageScaleFactor):
		...
		assert isinstance(pageScaleFactor, (float, int)
		    ), 'Argument pageScaleFactor must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    pageScaleFactor)
	...
	def Emulation_setScriptExecutionDisabled(self, value):
		...
		assert isinstance(value, (bool,)
		    ), 'Argument value must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    value)
		subdom_funcs = self.synchronous_command(
	...
	def Emulation_setEmulatedMedia(self, media):
		...
		assert isinstance(media, (str,)
		    ), 'Argument media must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    media)
	...
	def Emulation_setCPUThrottlingRate(self, rate):
		...
		assert isinstance(rate, (float, int)
		    ), 'Argument rate must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    rate)
	...
	def Emulation_setVirtualTimePolicy(self, policy, **kwargs):
		...
		if 'budget' in kwargs:
			assert isinstance(kwargs['budget'], (int,)
			    ), "Argument budget must be of type (['int']). Received type: %s" % type(
			    kwargs['budget'])
		expected = ['budget']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
	...
	def Security_showCertificateViewer(self):
		"""
		Function path: Security.showCertificateViewer
			Domain: Security
			Method name: showCertificateViewer
		
			No return value.
		
			Description: Displays native dialog with the certificate details.
		"""
		subdom_funcs = self.synchronous_command('Security.showCertificateViewer')
		return subdom_funcs
	...
	def Security_handleCertificateError(self, eventId, action):
		...
		assert isinstance(eventId, (int,)
		    ), 'Argument eventId must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    eventId)
	...
	def Security_setOverrideCertificateErrors(self, override):
		...
		assert isinstance(override, (bool,)
		    ), 'Argument override must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    override)
		subdom_funcs = self.synchronous_command(
	...
	def Network_enable(self, **kwargs):
		...
		if 'maxTotalBufferSize' in kwargs:
			assert isinstance(kwargs['maxTotalBufferSize'], (int,)
			    ), "Argument maxTotalBufferSize must be of type (['int']). Received type: %s" % type(
			    kwargs['maxTotalBufferSize'])
		if 'maxResourceBufferSize' in kwargs:
			assert isinstance(kwargs['maxResourceBufferSize'], (int,)
			    ), "Argument maxResourceBufferSize must be of type (['int']). Received type: %s" % type(
	...
	def Network_setUserAgentOverride(self, userAgent):
		...
		assert isinstance(userAgent, (str,)
		    ), 'Argument userAgent must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    userAgent)
	...
	def Network_setBlockedURLs(self, urls):
		...
		Function path: Network.setBlockedURLs
			...
			Parameters:
				Required arguments:
					'urls' (type: array) -> URLs to block.
			No return value.
		
			Description: Blocks specific URL from loading.
		"""
		assert isinstance(urls, (list, tuple)
		    ), 'Argument urls must be of type (<_ast.Tuple object at 0x7f14f6ff8438>). Received type: %s' % type(
		    urls)
	...
	def Network_setMonitoringXHREnabled(self, enabled):
		"""
		Function path: Network.setMonitoringXHREnabled
			Domain: Network
			Method name: setMonitoringXHREnabled
		
			WARNING: This function is marked 'Experimental'!
		
			Parameters:
				Required arguments:
					'enabled' (type: boolean) -> Monitoring enabled state.
			No return value.
		...
		assert isinstance(enabled, (bool,)
		    ...
		    enabled)
		subdom_funcs = self.synchronous_command('Network.setMonitoringXHREnabled',
		    enabled=enabled)
		return subdom_funcs
	...
	def Network_deleteCookie(self, cookieName, url):
		"""
		Function path: Network.deleteCookie
			Domain: Network
			Method name: deleteCookie
		...
		assert isinstance(url, (str,)
		    ...
		    url)
		subdom_funcs = self.synchronous_command('Network.deleteCookie',
		    cookieName=cookieName, url=url)
		return subdom_funcs

	def Network_setCookie(self, url, name, value, **kwargs):
		"""
		...
		assert isinstance(name, (str,)
		    ), 'Argument name must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    name)
		assert isinstance(value, (str,)
		    ), 'Argument value must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    value)
		if 'domain' in kwargs:
			assert isinstance(kwargs['domain'], (str,)
			    ), "Argument domain must be of type (['str']). Received type: %s" % type(
			    kwargs['domain'])
		if 'path' in kwargs:
		...
		if 'secure' in kwargs:
			assert isinstance(kwargs['secure'], (bool,)
			    ), "Argument secure must be of type (['bool']). Received type: %s" % type(
			    kwargs['secure'])
		if 'httpOnly' in kwargs:
			assert isinstance(kwargs['httpOnly'], (bool,)
			    ), "Argument httpOnly must be of type (['bool']). Received type: %s" % type(
			    kwargs['httpOnly'])
		expected = ['domain', 'path', 'secure', 'httpOnly', 'sameSite',
		    'expirationDate']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
		    ), "Allowed kwargs are ['domain', 'path', 'secure', 'httpOnly', 'sameSite', 'expirationDate']. Passed kwargs: %s" % passed_keys
		subdom_funcs = self.synchronous_command('Network.setCookie', url=url,
	...
	def Network_emulateNetworkConditions(self, offline, latency,
		...
		Function path: Network.emulateNetworkConditions
			...
			Parameters:
				Required arguments:
					...
					'latency' (type: number) -> Additional latency (ms).
					'downloadThroughput' (type: number) -> Maximal aggregated download throughput.
					'uploadThroughput' (type: number) -> Maximal aggregated upload throughput.
				Optional arguments:
		...
		assert isinstance(offline, (bool,)
		    ), 'Argument offline must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    offline)
		assert isinstance(latency, (float, int)
		    ), 'Argument latency must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    latency)
		assert isinstance(downloadThroughput, (float, int)
		    ), 'Argument downloadThroughput must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    downloadThroughput)
		assert isinstance(uploadThroughput, (float, int)
		    ), 'Argument uploadThroughput must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    uploadThroughput)
	...
	def Network_setCacheDisabled(self, cacheDisabled):
		...
		assert isinstance(cacheDisabled, (bool,)
		    ), 'Argument cacheDisabled must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    cacheDisabled)
	...
	def Network_setBypassServiceWorker(self, bypass):
		...
		assert isinstance(bypass, (bool,)
		    ), 'Argument bypass must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    bypass)
	...
	def Network_setDataSizeLimitsForTest(self, maxTotalSize, maxResourceSize):
		...
		assert isinstance(maxTotalSize, (int,)
		    ), 'Argument maxTotalSize must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    maxTotalSize)
		assert isinstance(maxResourceSize, (int,)
		    ), 'Argument maxResourceSize must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    maxResourceSize)
	...
	def Network_getCertificate(self, origin):
		...
		assert isinstance(origin, (str,)
		    ), 'Argument origin must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    origin)
	...
	def IndexedDB_requestDatabaseNames(self, securityOrigin):
		...
		assert isinstance(securityOrigin, (str,)
		    ), 'Argument securityOrigin must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    securityOrigin)
	...
	def IndexedDB_requestDatabase(self, securityOrigin, databaseName):
		...
		assert isinstance(databaseName, (str,)
		    ), 'Argument databaseName must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    databaseName)
	...
	def IndexedDB_requestData(self, securityOrigin, databaseName,
		...
		assert isinstance(objectStoreName, (str,)
		    ), 'Argument objectStoreName must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    objectStoreName)
		assert isinstance(indexName, (str,)
		    ), 'Argument indexName must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    indexName)
		assert isinstance(skipCount, (int,)
		    ), 'Argument skipCount must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    skipCount)
		assert isinstance(pageSize, (int,)
		    ), 'Argument pageSize must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    pageSize)
		expected = ['keyRange']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
	...
	def CacheStorage_deleteEntry(self, cacheId, request):
		...
		assert isinstance(request, (str,)
		    ), 'Argument request must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    request)
	...
	def DOMStorage_setDOMStorageItem(self, storageId, key, value):
		...
		assert isinstance(key, (str,)
		    ), 'Argument key must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    key)
		assert isinstance(value, (str,)
		    ), 'Argument value must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    value)
	...
	def DOM_getDocument(self, **kwargs):
		...
		if 'depth' in kwargs:
			assert isinstance(kwargs['depth'], (int,)
			    ), "Argument depth must be of type (['int']). Received type: %s" % type(
			    kwargs['depth'])
		if 'pierce' in kwargs:
			assert isinstance(kwargs['pierce'], (bool,)
			    ), "Argument pierce must be of type (['bool']). Received type: %s" % type(
			    kwargs['pierce'])
	...
	def DOM_querySelector(self, nodeId, selector):
		...
		assert isinstance(selector, (str,)
		    ), 'Argument selector must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    selector)
	...
	def DOM_setAttributesAsText(self, nodeId, text, **kwargs):
		...
		assert isinstance(text, (str,)
		    ), 'Argument text must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    text)
		if 'name' in kwargs:
	...
	def DOM_getOuterHTML(self, nodeId):
		"""
		Function path: DOM.getOuterHTML
			...
			Parameters:
				Required arguments:
					'nodeId' (type: NodeId) -> Id of the node to get markup for.
			Returns:
				'outerHTML' (type: string) -> Outer HTML markup.
		
			Description: Returns node's HTML markup.
		"""
		subdom_funcs = self.synchronous_command('DOM.getOuterHTML', nodeId=nodeId)
		return subdom_funcs
	...
	def DOM_setOuterHTML(self, nodeId, outerHTML):
		...
		assert isinstance(outerHTML, (str,)
		    ), 'Argument outerHTML must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    outerHTML)
	...
	def DOM_performSearch(self, query, **kwargs):
		...
		if 'includeUserAgentShadowDOM' in kwargs:
			assert isinstance(kwargs['includeUserAgentShadowDOM'], (bool,)
			    ), "Argument includeUserAgentShadowDOM must be of type (['bool']). Received type: %s" % type(
	...
	def DOM_getSearchResults(self, searchId, fromIndex, toIndex):
		...
		assert isinstance(searchId, (str,)
		    ), 'Argument searchId must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    searchId)
		assert isinstance(fromIndex, (int,)
		    ), 'Argument fromIndex must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    fromIndex)
		assert isinstance(toIndex, (int,)
		    ), 'Argument toIndex must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    toIndex)
	...
	def DOM_setInspectMode(self, mode, **kwargs):
		"""
		Function path: DOM.setInspectMode
			Domain: DOM
		...
		subdom_funcs = self.synchronous_command('DOM.setInspectMode', mode=mode,
		    **kwargs)
		return subdom_funcs

	def DOM_highlightRect(self, x, y, width, height, **kwargs):
		"""
		Function path: DOM.highlightRect
			...
			Parameters:
				...
				Optional arguments:
					'color' (type: RGBA) -> The highlight fill color (default: transparent).
					'outlineColor' (type: RGBA) -> The highlight outline color (default: transparent).
			No return value.
		
			Description: Highlights given rectangle. Coordinates are absolute with respect to the main frame viewport.
		"""
		assert isinstance(x, (int,)
		    ), 'Argument x must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    x)
		assert isinstance(y, (int,)
		    ), 'Argument y must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    y)
		assert isinstance(width, (int,)
		    ), 'Argument width must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    width)
		...
		subdom_funcs = self.synchronous_command('DOM.highlightRect', x=x, y=y,
		    width=width, height=height, **kwargs)
		return subdom_funcs

	def DOM_highlightQuad(self, quad, **kwargs):
		"""
		Function path: DOM.highlightQuad
			Domain: DOM
			...
			Parameters:
				Required arguments:
					'quad' (type: Quad) -> Quad to highlight
				Optional arguments:
					'color' (type: RGBA) -> The highlight fill color (default: transparent).
					'outlineColor' (type: RGBA) -> The highlight outline color (default: transparent).
			No return value.
		...
		subdom_funcs = self.synchronous_command('DOM.highlightQuad', quad=quad,
		    **kwargs)
		return subdom_funcs

	def DOM_highlightNode(self, highlightConfig, **kwargs):
		"""
		Function path: DOM.highlightNode
			...
			Parameters:
				...
				Optional arguments:
					'nodeId' (type: NodeId) -> Identifier of the node to highlight.
					'backendNodeId' (type: BackendNodeId) -> Identifier of the backend node to highlight.
	...
	def DOM_highlightFrame(self, frameId, **kwargs):
		"""
		Function path: DOM.highlightFrame
			Domain: DOM
			...
			Parameters:
				...
				Optional arguments:
					'contentColor' (type: RGBA) -> The content box highlight fill color (default: transparent).
					'contentOutlineColor' (type: RGBA) -> The content box highlight outline color (default: transparent).
			No return value.
		...
		subdom_funcs = self.synchronous_command('DOM.highlightFrame', frameId=
		    frameId, **kwargs)
		return subdom_funcs
	...
	def DOM_pushNodeByPathToFrontend(self, path):
		...
		assert isinstance(path, (str,)
		    ), 'Argument path must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    path)
	...
	def DOM_pushNodesByBackendIdsToFrontend(self, backendNodeIds):
		...
		assert isinstance(backendNodeIds, (list, tuple)
		    ), 'Argument backendNodeIds must be of type (<_ast.Tuple object at 0x7f14f6ff8438>). Received type: %s' % type(
		    backendNodeIds)
	...
	def DOM_resolveNode(self, nodeId, **kwargs):
		"""
		...
		subdom_funcs = self.synchronous_command('DOM.resolveNode', nodeId=nodeId,
		    **kwargs)
		return subdom_funcs
	...
	def DOM_focus(self, nodeId):
		...
		Function path: DOM.focus
			...
			Parameters:
				Required arguments:
					'nodeId' (type: NodeId) -> Id of the node to focus.
			No return value.
		
			Description: Focuses the given element.
		"""
		subdom_funcs = self.synchronous_command('DOM.focus', nodeId=nodeId)
		return subdom_funcs

	def DOM_setFileInputFiles(self, nodeId, files):
		"""
		Function path: DOM.setFileInputFiles
			...
			Parameters:
				Required arguments:
					'nodeId' (type: NodeId) -> Id of the file input node to set files for.
		...
		assert isinstance(files, (list, tuple)
		    ), 'Argument files must be of type (<_ast.Tuple object at 0x7f14f6ff8438>). Received type: %s' % type(
		    files)
		subdom_funcs = self.synchronous_command('DOM.setFileInputFiles', nodeId=
		    nodeId, files=files)
		return subdom_funcs

	def DOM_getBoxModel(self, nodeId):
		"""
		Function path: DOM.getBoxModel
			...
			Parameters:
				Required arguments:
					'nodeId' (type: NodeId) -> Id of the node to get box model for.
			Returns:
				'model' (type: BoxModel) -> Box model for the node.
		
			Description: Returns boxes for the currently selected nodes.
		"""
		subdom_funcs = self.synchronous_command('DOM.getBoxModel', nodeId=nodeId)
		return subdom_funcs
	...
	def DOM_getHighlightObjectForTest(self, nodeId):
		"""
		Function path: DOM.getHighlightObjectForTest
			Domain: DOM
			...
			Parameters:
				Required arguments:
					'nodeId' (type: NodeId) -> Id of the node to get highlight object for.
			Returns:
				'highlight' (type: object) -> Highlight data for the node.
		
			Description: For testing.
		"""
		subdom_funcs = self.synchronous_command('DOM.getHighlightObjectForTest',
		    nodeId=nodeId)
		return subdom_funcs
	...
	def CSS_setKeyframeKey(self, styleSheetId, range, keyText):
		...
		assert isinstance(keyText, (str,)
		    ), 'Argument keyText must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    keyText)
	...
	def CSS_setStyleTexts(self, edits):
		...
		assert isinstance(edits, (list, tuple)
		    ), 'Argument edits must be of type (<_ast.Tuple object at 0x7f14f6ff8438>). Received type: %s' % type(
		    edits)
	...
	def CSS_addRule(self, styleSheetId, ruleText, location):
		...
		assert isinstance(ruleText, (str,)
		    ), 'Argument ruleText must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    ruleText)
	...
	def CSS_forcePseudoState(self, nodeId, forcedPseudoClasses):
		...
		assert isinstance(forcedPseudoClasses, (list, tuple)
		    ), 'Argument forcedPseudoClasses must be of type (<_ast.Tuple object at 0x7f14f6ff8438>). Received type: %s' % type(
		    forcedPseudoClasses)
	...
	def CSS_setEffectivePropertyValueForNode(self, nodeId, propertyName, value):
		...
		assert isinstance(propertyName, (str,)
		    ), 'Argument propertyName must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    propertyName)
		assert isinstance(value, (str,)
		    ), 'Argument value must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    value)
	...
	def CSS_getLayoutTreeAndStyles(self, computedStyleWhitelist):
		"""
		Function path: CSS.getLayoutTreeAndStyles
			Domain: CSS
			Method name: getLayoutTreeAndStyles
			...
			Returns:
				'layoutTreeNodes' (type: array) -> No description
				'computedStyles' (type: array) -> No description
		...
		assert isinstance(computedStyleWhitelist, (list, tuple)
		    ), 'Argument computedStyleWhitelist must be of type (<_ast.Tuple object at 0x7f14f6ff8438>). Received type: %s' % type(
		    computedStyleWhitelist)
		subdom_funcs = self.synchronous_command('CSS.getLayoutTreeAndStyles',
	...
	def IO_read(self, handle, **kwargs):
		...
		if 'offset' in kwargs:
			assert isinstance(kwargs['offset'], (int,)
			    ), "Argument offset must be of type (['int']). Received type: %s" % type(
			    kwargs['offset'])
		if 'size' in kwargs:
	...
	def DOMDebugger_setEventListenerBreakpoint(self, eventName, **kwargs):
		...
		assert isinstance(eventName, (str,)
		    ), 'Argument eventName must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    eventName)
		if 'targetName' in kwargs:
			assert isinstance(kwargs['targetName'], (str,)
			    ), "Argument targetName must be of type (['str']). Received type: %s" % type(
			    kwargs['targetName'])
		expected = ['targetName']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
	...
	def Target_setDiscoverTargets(self, discover):
		...
		assert isinstance(discover, (bool,)
		    ), 'Argument discover must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    discover)
	...
	def Target_setAutoAttach(self, autoAttach, waitForDebuggerOnStart):
		...
		assert isinstance(waitForDebuggerOnStart, (bool,)
		    ), 'Argument waitForDebuggerOnStart must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
	...
	def Target_setRemoteLocations(self, locations):
		...
		assert isinstance(locations, (list, tuple)
		    ), 'Argument locations must be of type (<_ast.Tuple object at 0x7f14f6ff8438>). Received type: %s' % type(
		    locations)
		subdom_funcs = self.synchronous_command('Target.setRemoteLocations',
		    locations=locations)
		return subdom_funcs

	def Target_sendMessageToTarget(self, targetId, message):
		"""
		Function path: Target.sendMessageToTarget
			...
			Parameters:
				Required arguments:
					'targetId' (type: string) -> No description
		...
		assert isinstance(targetId, (str,)
		    ), 'Argument targetId must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    targetId)
		assert isinstance(message, (str,)
		    ), 'Argument message must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    message)
		subdom_funcs = self.synchronous_command('Target.sendMessageToTarget',
		    targetId=targetId, message=message)
		return subdom_funcs
		...
		Function path: Target.attachToTarget
			...
			Parameters:
				Required arguments:
					'targetId' (type: TargetID) -> No description
			Returns:
				'success' (type: boolean) -> Whether attach succeeded.
	...
	def Target_detachFromTarget(self, targetId):
		"""
		...
		"""
		subdom_funcs = self.synchronous_command('Target.detachFromTarget',
		    targetId=targetId)
		return subdom_funcs
	...
	def ServiceWorker_unregister(self, scopeURL):
		...
		assert isinstance(scopeURL, (str,)
		    ), 'Argument scopeURL must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    scopeURL)
	...
	def ServiceWorker_stopWorker(self, versionId):
		...
		assert isinstance(versionId, (str,)
		    ), 'Argument versionId must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    versionId)
	...
	def ServiceWorker_setForceUpdateOnPageLoad(self, forceUpdateOnPageLoad):
		...
		assert isinstance(forceUpdateOnPageLoad, (bool,)
		    ), 'Argument forceUpdateOnPageLoad must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
	...
	def ServiceWorker_deliverPushMessage(self, origin, registrationId, data):
		...
		assert isinstance(registrationId, (str,)
		    ), 'Argument registrationId must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    registrationId)
		assert isinstance(data, (str,)
		    ), 'Argument data must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    data)
	...
	def ServiceWorker_dispatchSyncEvent(self, origin, registrationId, tag,
		...
		assert isinstance(tag, (str,)
		    ), 'Argument tag must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    tag)
		assert isinstance(lastChance, (bool,)
		    ), 'Argument lastChance must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    lastChance)
	...
	def Input_dispatchKeyEvent(self, type, **kwargs):
		...
		Function path: Input.dispatchKeyEvent
			...
			Parameters:
				...
				Optional arguments:
					...
					'timestamp' (type: number) -> Time at which the event occurred. Measured in UTC time in seconds since January 1, 1970 (default: current time).
		...
		assert isinstance(type, (str,)
		    ), 'Argument type must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    type)
		if 'modifiers' in kwargs:
			assert isinstance(kwargs['modifiers'], (int,)
			    ), "Argument modifiers must be of type (['int']). Received type: %s" % type(
			    kwargs['modifiers'])
		if 'timestamp' in kwargs:
			assert isinstance(kwargs['timestamp'], (float, int)
			    ), "Argument timestamp must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['timestamp'])
		if 'text' in kwargs:
		...
		if 'unmodifiedText' in kwargs:
			assert isinstance(kwargs['unmodifiedText'], (str,)
			    ), "Argument unmodifiedText must be of type (['str']). Received type: %s" % type(
			    kwargs['unmodifiedText'])
		if 'keyIdentifier' in kwargs:
			assert isinstance(kwargs['keyIdentifier'], (str,)
			    ), "Argument keyIdentifier must be of type (['str']). Received type: %s" % type(
			    kwargs['keyIdentifier'])
		if 'code' in kwargs:
			assert isinstance(kwargs['code'], (str,)
			    ), "Argument code must be of type (['str']). Received type: %s" % type(
			    kwargs['code'])
		if 'key' in kwargs:
	...
	def Input_dispatchMouseEvent(self, type, x, y, **kwargs):
		...
		Function path: Input.dispatchMouseEvent
			...
			Parameters:
				Required arguments:
					...
					'x' (type: integer) -> X coordinate of the event relative to the main frame's viewport.
					'y' (type: integer) -> Y coordinate of the event relative to the main frame's viewport. 0 refers to the top of the viewport and Y increases as it proceeds towards the bottom of the viewport.
				Optional arguments:
					'modifiers' (type: integer) -> Bit field representing pressed modifier keys. Alt=1, Ctrl=2, Meta/Command=4, Shift=8 (default: 0).
					'timestamp' (type: number) -> Time at which the event occurred. Measured in UTC time in seconds since January 1, 1970 (default: current time).
		...
		if 'clickCount' in kwargs:
			assert isinstance(kwargs['clickCount'], (int,)
			    ), "Argument clickCount must be of type (['int']). Received type: %s" % type(
			    kwargs['clickCount'])
		expected = ['modifiers', 'timestamp', 'button', 'clickCount']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
		    ), "Allowed kwargs are ['modifiers', 'timestamp', 'button', 'clickCount']. Passed kwargs: %s" % passed_keys
	...
	def Input_dispatchTouchEvent(self, type, touchPoints, **kwargs):
		...
		Function path: Input.dispatchTouchEvent
			...
			Parameters:
				Required arguments:
					'type' (type: string) -> Type of the touch event.
					'touchPoints' (type: array) -> Touch points.
				Optional arguments:
					'modifiers' (type: integer) -> Bit field representing pressed modifier keys. Alt=1, Ctrl=2, Meta/Command=4, Shift=8 (default: 0).
					'timestamp' (type: number) -> Time at which the event occurred. Measured in UTC time in seconds since January 1, 1970 (default: current time).
			No return value.
		...
		assert isinstance(touchPoints, (list, tuple)
		    ), 'Argument touchPoints must be of type (<_ast.Tuple object at 0x7f14f6ff8438>). Received type: %s' % type(
		    touchPoints)
		if 'modifiers' in kwargs:
			assert isinstance(kwargs['modifiers'], (int,)
			    ), "Argument modifiers must be of type (['int']). Received type: %s" % type(
	...
	def Input_emulateTouchFromMouseEvent(self, type, x, y, timestamp, button,
	    **kwargs):
		...
		Function path: Input.emulateTouchFromMouseEvent
			...
			Parameters:
				Required arguments:
					...
					'timestamp' (type: number) -> Time at which the event occurred. Measured in UTC time in seconds since January 1, 1970.
		...
		assert isinstance(timestamp, (float, int)
		    ), 'Argument timestamp must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    timestamp)
		assert isinstance(button, (str,)
		    ), 'Argument button must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    button)
		if 'deltaX' in kwargs:
			assert isinstance(kwargs['deltaX'], (float, int)
			    ), "Argument deltaX must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['deltaX'])
		if 'deltaY' in kwargs:
			assert isinstance(kwargs['deltaY'], (float, int)
			    ), "Argument deltaY must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['deltaY'])
		if 'modifiers' in kwargs:
			assert isinstance(kwargs['modifiers'], (int,)
			    ), "Argument modifiers must be of type (['int']). Received type: %s" % type(
	...
	def Input_synthesizePinchGesture(self, x, y, scaleFactor, **kwargs):
		...
		Function path: Input.synthesizePinchGesture
			...
			Parameters:
				Required arguments:
					'x' (type: integer) -> X coordinate of the start of the gesture in CSS pixels.
					'y' (type: integer) -> Y coordinate of the start of the gesture in CSS pixels.
		...
		assert isinstance(scaleFactor, (float, int)
		    ), 'Argument scaleFactor must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    scaleFactor)
		if 'relativeSpeed' in kwargs:
			assert isinstance(kwargs['relativeSpeed'], (int,)
			    ), "Argument relativeSpeed must be of type (['int']). Received type: %s" % type(
	...
	def Input_synthesizeScrollGesture(self, x, y, **kwargs):
		...
		Function path: Input.synthesizeScrollGesture
			...
			Parameters:
				Required arguments:
					...
					'y' (type: integer) -> Y coordinate of the start of the gesture in CSS pixels.
				Optional arguments:
					'xDistance' (type: integer) -> The distance to scroll along the X axis (positive to scroll left).
					'yDistance' (type: integer) -> The distance to scroll along the Y axis (positive to scroll up).
					'xOverscroll' (type: integer) -> The number of additional pixels to scroll back along the X axis, in addition to the given distance.
					'yOverscroll' (type: integer) -> The number of additional pixels to scroll back along the Y axis, in addition to the given distance.
		...
		if 'xDistance' in kwargs:
			assert isinstance(kwargs['xDistance'], (int,)
			    ), "Argument xDistance must be of type (['int']). Received type: %s" % type(
			    kwargs['xDistance'])
		if 'yDistance' in kwargs:
			assert isinstance(kwargs['yDistance'], (int,)
			    ), "Argument yDistance must be of type (['int']). Received type: %s" % type(
			    kwargs['yDistance'])
		if 'xOverscroll' in kwargs:
			assert isinstance(kwargs['xOverscroll'], (int,)
			    ), "Argument xOverscroll must be of type (['int']). Received type: %s" % type(
			    kwargs['xOverscroll'])
		if 'yOverscroll' in kwargs:
			assert isinstance(kwargs['yOverscroll'], (int,)
			    ), "Argument yOverscroll must be of type (['int']). Received type: %s" % type(
			    kwargs['yOverscroll'])
		if 'preventFling' in kwargs:
			assert isinstance(kwargs['preventFling'], (bool,)
			    ), "Argument preventFling must be of type (['bool']). Received type: %s" % type(
			    kwargs['preventFling'])
		if 'speed' in kwargs:
			assert isinstance(kwargs['speed'], (int,)
			    ), "Argument speed must be of type (['int']). Received type: %s" % type(
			    kwargs['speed'])
		if 'repeatCount' in kwargs:
			assert isinstance(kwargs['repeatCount'], (int,)
			    ), "Argument repeatCount must be of type (['int']). Received type: %s" % type(
			    kwargs['repeatCount'])
		if 'repeatDelayMs' in kwargs:
			assert isinstance(kwargs['repeatDelayMs'], (int,)
			    ), "Argument repeatDelayMs must be of type (['int']). Received type: %s" % type(
			    kwargs['repeatDelayMs'])
		if 'interactionMarkerName' in kwargs:
			assert isinstance(kwargs['interactionMarkerName'], (str,)
			    ), "Argument interactionMarkerName must be of type (['str']). Received type: %s" % type(
	...
	def Input_synthesizeTapGesture(self, x, y, **kwargs):
		...
		if 'duration' in kwargs:
			assert isinstance(kwargs['duration'], (int,)
			    ), "Argument duration must be of type (['int']). Received type: %s" % type(
			    kwargs['duration'])
		if 'tapCount' in kwargs:
			assert isinstance(kwargs['tapCount'], (int,)
			    ), "Argument tapCount must be of type (['int']). Received type: %s" % type(
			    kwargs['tapCount'])
	...
	def LayerTree_loadSnapshot(self, tiles):
		...
		assert isinstance(tiles, (list, tuple)
		    ), 'Argument tiles must be of type (<_ast.Tuple object at 0x7f14f6ff8438>). Received type: %s' % type(
		    tiles)
	...
	def LayerTree_profileSnapshot(self, snapshotId, **kwargs):
		...
		if 'minRepeatCount' in kwargs:
			assert isinstance(kwargs['minRepeatCount'], (int,)
			    ), "Argument minRepeatCount must be of type (['int']). Received type: %s" % type(
			    kwargs['minRepeatCount'])
		if 'minDuration' in kwargs:
			assert isinstance(kwargs['minDuration'], (float, int)
			    ), "Argument minDuration must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['minDuration'])
	...
	def LayerTree_replaySnapshot(self, snapshotId, **kwargs):
		...
		if 'fromStep' in kwargs:
			assert isinstance(kwargs['fromStep'], (int,)
			    ), "Argument fromStep must be of type (['int']). Received type: %s" % type(
			    kwargs['fromStep'])
		if 'toStep' in kwargs:
			assert isinstance(kwargs['toStep'], (int,)
			    ), "Argument toStep must be of type (['int']). Received type: %s" % type(
			    kwargs['toStep'])
		if 'scale' in kwargs:
			assert isinstance(kwargs['scale'], (float, int)
			    ), "Argument scale must be of type (['float', 'int']). Received type: %s" % type(
	...
	def Tracing_start(self, **kwargs):
		...
		if 'categories' in kwargs:
			assert isinstance(kwargs['categories'], (str,)
			    ), "Argument categories must be of type (['str']). Received type: %s" % type(
			    kwargs['categories'])
		if 'options' in kwargs:
			assert isinstance(kwargs['options'], (str,)
			    ), "Argument options must be of type (['str']). Received type: %s" % type(
			    kwargs['options'])
		if 'bufferUsageReportingInterval' in kwargs:
			assert isinstance(kwargs['bufferUsageReportingInterval'], (float, int)
			    ), "Argument bufferUsageReportingInterval must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['bufferUsageReportingInterval'])
		if 'transferMode' in kwargs:
			assert isinstance(kwargs['transferMode'], (str,)
			    ), "Argument transferMode must be of type (['str']). Received type: %s" % type(
			    kwargs['transferMode'])
	...
	def Tracing_recordClockSyncMarker(self, syncId):
		...
		assert isinstance(syncId, (str,)
		    ), 'Argument syncId must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    syncId)
	...
	def Animation_setPlaybackRate(self, playbackRate):
		...
		assert isinstance(playbackRate, (float, int)
		    ), 'Argument playbackRate must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    playbackRate)
	...
	def Animation_getCurrentTime(self, id):
		...
		assert isinstance(id, (str,)
		    ), 'Argument id must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    id)
	...
	def Animation_setPaused(self, animations, paused):
		...
		assert isinstance(animations, (list, tuple)
		    ), 'Argument animations must be of type (<_ast.Tuple object at 0x7f14f6ff8438>). Received type: %s' % type(
		    animations)
		assert isinstance(paused, (bool,)
		    ), 'Argument paused must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    paused)
	...
	def Animation_setTiming(self, animationId, duration, delay):
		...
		assert isinstance(animationId, (str,)
		    ), 'Argument animationId must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    animationId)
		assert isinstance(duration, (float, int)
		    ), 'Argument duration must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    duration)
		assert isinstance(delay, (float, int)
		    ), 'Argument delay must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    delay)
	...
	def Animation_seekAnimations(self, animations, currentTime):
		...
		assert isinstance(currentTime, (float, int)
		    ), 'Argument currentTime must be of type (<_ast.Tuple object at 0x7f14f6ff89b0>). Received type: %s' % type(
		    currentTime)
	...
	def Accessibility_getPartialAXTree(self, nodeId, **kwargs):
		...
		if 'fetchRelatives' in kwargs:
			assert isinstance(kwargs['fetchRelatives'], (bool,)
			    ), "Argument fetchRelatives must be of type (['bool']). Received type: %s" % type(
	...
	def Storage_clearDataForOrigin(self, origin, storageTypes):
		...
		assert isinstance(storageTypes, (str,)
		    ), 'Argument storageTypes must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    storageTypes)
	...
	def Log_startViolationsReport(self, config):
		...
		assert isinstance(config, (list, tuple)
		    ), 'Argument config must be of type (<_ast.Tuple object at 0x7f14f6ff8438>). Received type: %s' % type(
		    config)
	...
	def Tethering_bind(self, port):
		...
		assert isinstance(port, (int,)
		    ), 'Argument port must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    port)
	...
	def Runtime_evaluate(self, expression, **kwargs):
		...
		assert isinstance(expression, (str,)
		    ), 'Argument expression must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    expression)
		if 'objectGroup' in kwargs:
			assert isinstance(kwargs['objectGroup'], (str,)
			    ), "Argument objectGroup must be of type (['str']). Received type: %s" % type(
	...
	def Runtime_callFunctionOn(self, objectId, functionDeclaration, **kwargs):
		"""
		Function path: Runtime.callFunctionOn
			...
			Parameters:
				Required arguments:
					'objectId' (type: RemoteObjectId) -> Identifier of the object to call function on.
		...
		assert isinstance(functionDeclaration, (str,)
		    ), 'Argument functionDeclaration must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    functionDeclaration)
		if 'arguments' in kwargs:
			assert isinstance(kwargs['arguments'], (list, tuple)
			    ), "Argument arguments must be of type (['list', 'tuple']). Received type: %s" % type(
			    kwargs['arguments'])
		if 'silent' in kwargs:
			assert isinstance(kwargs['silent'], (bool,)
			    ), "Argument silent must be of type (['bool']). Received type: %s" % type(
		...
		if 'awaitPromise' in kwargs:
			assert isinstance(kwargs['awaitPromise'], (bool,)
			    ...
			    kwargs['awaitPromise'])
		expected = ['arguments', 'silent', 'returnByValue', 'generatePreview',
		    'userGesture', 'awaitPromise']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
		    ), "Allowed kwargs are ['arguments', 'silent', 'returnByValue', 'generatePreview', 'userGesture', 'awaitPromise']. Passed kwargs: %s" % passed_keys
		subdom_funcs = self.synchronous_command('Runtime.callFunctionOn',
		    objectId=objectId, functionDeclaration=functionDeclaration, **kwargs)
		return subdom_funcs
	...
	def Runtime_getProperties(self, objectId, **kwargs):
		...
		if 'ownProperties' in kwargs:
			assert isinstance(kwargs['ownProperties'], (bool,)
			    ), "Argument ownProperties must be of type (['bool']). Received type: %s" % type(
			    kwargs['ownProperties'])
		if 'accessorPropertiesOnly' in kwargs:
			assert isinstance(kwargs['accessorPropertiesOnly'], (bool,)
			    ), "Argument accessorPropertiesOnly must be of type (['bool']). Received type: %s" % type(
	...
	def Runtime_releaseObjectGroup(self, objectGroup):
		...
		assert isinstance(objectGroup, (str,)
		    ), 'Argument objectGroup must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    objectGroup)
	...
	def Runtime_compileScript(self, expression, sourceURL, persistScript, **kwargs
		...
		assert isinstance(sourceURL, (str,)
		    ), 'Argument sourceURL must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    sourceURL)
		assert isinstance(persistScript, (bool,)
		    ), 'Argument persistScript must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    persistScript)
	...
	def Debugger_setBreakpointsActive(self, active):
		...
		assert isinstance(active, (bool,)
		    ), 'Argument active must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    active)
	...
	def Debugger_setSkipAllPauses(self, skip):
		...
		assert isinstance(skip, (bool,)
		    ), 'Argument skip must be of type (<_ast.Tuple object at 0x7f14f6ff8588>). Received type: %s' % type(
		    skip)
	...
	def Debugger_setBreakpointByUrl(self, lineNumber, **kwargs):
		...
		assert isinstance(lineNumber, (int,)
		    ), 'Argument lineNumber must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    lineNumber)
		if 'url' in kwargs:
		...
		if 'urlRegex' in kwargs:
			assert isinstance(kwargs['urlRegex'], (str,)
			    ), "Argument urlRegex must be of type (['str']). Received type: %s" % type(
			    kwargs['urlRegex'])
		if 'columnNumber' in kwargs:
			assert isinstance(kwargs['columnNumber'], (int,)
			    ), "Argument columnNumber must be of type (['int']). Received type: %s" % type(
			    kwargs['columnNumber'])
		if 'condition' in kwargs:
			assert isinstance(kwargs['condition'], (str,)
			    ), "Argument condition must be of type (['str']). Received type: %s" % type(
			    kwargs['condition'])
	...
	def Debugger_getPossibleBreakpoints(self, start, **kwargs):
		...
		Function path: Debugger.getPossibleBreakpoints
			...
			Parameters:
				...
				Optional arguments:
					'end' (type: Location) -> End of range to search possible breakpoint locations in (excluding). When not specifed, end of scripts is used as end of range.
		...
		if 'restrictToFunction' in kwargs:
			assert isinstance(kwargs['restrictToFunction'], (bool,)
			    ), "Argument restrictToFunction must be of type (['bool']). Received type: %s" % type(
	...
	def Debugger_continueToLocation(self, location):
		"""
	...
	def Debugger_setScriptSource(self, scriptId, scriptSource, **kwargs):
		...
		if 'dryRun' in kwargs:
			assert isinstance(kwargs['dryRun'], (bool,)
			    ), "Argument dryRun must be of type (['bool']). Received type: %s" % type(
			    kwargs['dryRun'])
		expected = ['dryRun']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
	...
	def Debugger_setPauseOnExceptions(self, state):
		...
		assert isinstance(state, (str,)
		    ), 'Argument state must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    state)
	...
	def Debugger_evaluateOnCallFrame(self, callFrameId, expression, **kwargs):
		...
		if 'throwOnSideEffect' in kwargs:
			assert isinstance(kwargs['throwOnSideEffect'], (bool,)
			    ), "Argument throwOnSideEffect must be of type (['bool']). Received type: %s" % type(
	...
	def Debugger_setVariableValue(self, scopeNumber, variableName, newValue,
		...
		assert isinstance(scopeNumber, (int,)
		    ), 'Argument scopeNumber must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    scopeNumber)
		assert isinstance(variableName, (str,)
		    ), 'Argument variableName must be of type (<_ast.Tuple object at 0x7f14f6ff8b00>). Received type: %s' % type(
		    variableName)
	...
	def Debugger_setAsyncCallStackDepth(self, maxDepth):
		...
		assert isinstance(maxDepth, (int,)
		    ), 'Argument maxDepth must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    maxDepth)
	...
	def Debugger_setBlackboxPatterns(self, patterns):
		...
		assert isinstance(patterns, (list, tuple)
		    ), 'Argument patterns must be of type (<_ast.Tuple object at 0x7f14f6ff8438>). Received type: %s' % type(
		    patterns)
	...
	def Debugger_setBlackboxedRanges(self, scriptId, positions):
		...
		assert isinstance(positions, (list, tuple)
		    ), 'Argument positions must be of type (<_ast.Tuple object at 0x7f14f6ff8438>). Received type: %s' % type(
		    positions)
	...
	def Profiler_setSamplingInterval(self, interval):
		...
		assert isinstance(interval, (int,)
		    ), 'Argument interval must be of type (<_ast.Tuple object at 0x7f14f6ff87b8>). Received type: %s' % type(
		    interval)
	...
	def Profiler_startPreciseCoverage(self, **kwargs):
		...
		if 'callCount' in kwargs:
			assert isinstance(kwargs['callCount'], (bool,)
			    ), "Argument callCount must be of type (['bool']). Received type: %s" % type(
			    kwargs['callCount'])
		expected = ['callCount']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
		    ), "Allowed kwargs are ['callCount']. Passed kwargs: %s" % passed_keys
	...
	def HeapProfiler_startTrackingHeapObjects(self, **kwargs):
		...
		if 'trackAllocations' in kwargs:
			assert isinstance(kwargs['trackAllocations'], (bool,)
			    ), "Argument trackAllocations must be of type (['bool']). Received type: %s" % type(
	...
	def HeapProfiler_stopTrackingHeapObjects(self, **kwargs):
		...
		if 'reportProgress' in kwargs:
			assert isinstance(kwargs['reportProgress'], (bool,)
			    ), "Argument reportProgress must be of type (['bool']). Received type: %s" % type(
	...
	def HeapProfiler_startSampling(self, **kwargs):
		...
		if 'samplingInterval' in kwargs:
			assert isinstance(kwargs['samplingInterval'], (float, int)
			    ), "Argument samplingInterval must be of type (['float', 'int']). Received type: %s" % type(
