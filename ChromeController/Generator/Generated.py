...
class ChromeRemoteDebugInterface(ChromeInterface):
	...
	def Memory_setPressureNotificationsSuppressed(self, suppressed):
		...
		assert isinstance(suppressed, (bool,)
		    ), 'Argument suppressed must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    suppressed)
	...
	def Page_addScriptToEvaluateOnLoad(self, scriptSource):
		...
		assert isinstance(scriptSource, (str,)
		    ), 'Argument scriptSource must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    scriptSource)
	...
	def Page_addScriptToEvaluateOnNewDocument(self, source):
		...
		assert isinstance(source, (str,)
		    ), 'Argument source must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    source)
		subdom_funcs = self.synchronous_command(
	...
	def Page_setAutoAttachToCreatedPages(self, autoAttach):
		...
		assert isinstance(autoAttach, (bool,)
		    ), 'Argument autoAttach must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    autoAttach)
	...
	def Page_setAdBlockingEnabled(self, enabled):
		...
		assert isinstance(enabled, (bool,)
		    ), 'Argument enabled must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    enabled)
	...
	def Page_navigate(self, url, **kwargs):
		...
		assert isinstance(url, (str,)
		    ), 'Argument url must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    url)
	...
	def Page_navigateToHistoryEntry(self, entryId):
		...
		assert isinstance(entryId, (int,)
		    ), 'Argument entryId must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    entryId)
	...
	def Page_deleteCookie(self, cookieName, url):
		...
		assert isinstance(cookieName, (str,)
		    ), 'Argument cookieName must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    cookieName)
		assert isinstance(url, (str,)
		    ), 'Argument url must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    url)
	...
	def Page_searchInResource(self, frameId, url, query, **kwargs):
		...
		assert isinstance(query, (str,)
		    ), 'Argument query must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    query)
	...
	def Page_setDocumentContent(self, frameId, html):
		...
		assert isinstance(html, (str,)
		    ), 'Argument html must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    html)
	...
	def Page_setDeviceMetricsOverride(self, width, height, deviceScaleFactor,
		...
		assert isinstance(width, (int,)
		    ), 'Argument width must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    width)
		assert isinstance(height, (int,)
		    ), 'Argument height must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    height)
		assert isinstance(deviceScaleFactor, (float, int)
		    ), 'Argument deviceScaleFactor must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    deviceScaleFactor)
		assert isinstance(mobile, (bool,)
		    ), 'Argument mobile must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    mobile)
		if 'scale' in kwargs:
		...
		if 'dontSetVisibleSize' in kwargs:
			assert isinstance(kwargs['dontSetVisibleSize'], (bool,)
			    ), "Argument dontSetVisibleSize must be of type (['bool']). Received type: %s" % type(
	...
	def Page_setDeviceOrientationOverride(self, alpha, beta, gamma):
		...
		assert isinstance(alpha, (float, int)
		    ), 'Argument alpha must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    alpha)
		assert isinstance(beta, (float, int)
		    ), 'Argument beta must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    beta)
		assert isinstance(gamma, (float, int)
		    ), 'Argument gamma must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    gamma)
	...
	def Page_printToPDF(self, **kwargs):
		...
		if 'landscape' in kwargs:
			assert isinstance(kwargs['landscape'], (bool,)
			    ), "Argument landscape must be of type (['bool']). Received type: %s" % type(
			    kwargs['landscape'])
		if 'displayHeaderFooter' in kwargs:
			assert isinstance(kwargs['displayHeaderFooter'], (bool,)
			    ), "Argument displayHeaderFooter must be of type (['bool']). Received type: %s" % type(
			    kwargs['displayHeaderFooter'])
		if 'printBackground' in kwargs:
			assert isinstance(kwargs['printBackground'], (bool,)
			    ), "Argument printBackground must be of type (['bool']). Received type: %s" % type(
		...
		if 'paperWidth' in kwargs:
			assert isinstance(kwargs['paperWidth'], (float, int)
			    ), "Argument paperWidth must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['paperWidth'])
		if 'paperHeight' in kwargs:
			assert isinstance(kwargs['paperHeight'], (float, int)
			    ), "Argument paperHeight must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['paperHeight'])
		if 'marginTop' in kwargs:
			assert isinstance(kwargs['marginTop'], (float, int)
			    ), "Argument marginTop must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['marginTop'])
		if 'marginBottom' in kwargs:
			assert isinstance(kwargs['marginBottom'], (float, int)
			    ), "Argument marginBottom must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['marginBottom'])
		if 'marginLeft' in kwargs:
			assert isinstance(kwargs['marginLeft'], (float, int)
			    ), "Argument marginLeft must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['marginLeft'])
		if 'marginRight' in kwargs:
			assert isinstance(kwargs['marginRight'], (float, int)
			    ), "Argument marginRight must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['marginRight'])
		if 'pageRanges' in kwargs:
			assert isinstance(kwargs['pageRanges'], (str,)
			    ), "Argument pageRanges must be of type (['str']). Received type: %s" % type(
			    kwargs['pageRanges'])
		if 'ignoreInvalidPageRanges' in kwargs:
			assert isinstance(kwargs['ignoreInvalidPageRanges'], (bool,)
			    ), "Argument ignoreInvalidPageRanges must be of type (['bool']). Received type: %s" % type(
	...
	def Page_screencastFrameAck(self, sessionId):
		...
		assert isinstance(sessionId, (int,)
		    ), 'Argument sessionId must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    sessionId)
	...
	def Page_handleJavaScriptDialog(self, accept, **kwargs):
		...
		assert isinstance(accept, (bool,)
		    ), 'Argument accept must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    accept)
	...
	def Page_createIsolatedWorld(self, frameId, **kwargs):
		...
		if 'worldName' in kwargs:
			assert isinstance(kwargs['worldName'], (str,)
			    ), "Argument worldName must be of type (['str']). Received type: %s" % type(
			    kwargs['worldName'])
		if 'grantUniveralAccess' in kwargs:
			assert isinstance(kwargs['grantUniveralAccess'], (bool,)
			    ), "Argument grantUniveralAccess must be of type (['bool']). Received type: %s" % type(
	...
	def Page_setDownloadBehavior(self, behavior, **kwargs):
		...
		assert isinstance(behavior, (str,)
		    ), 'Argument behavior must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    behavior)
		if 'downloadPath' in kwargs:
			assert isinstance(kwargs['downloadPath'], (str,)
			    ), "Argument downloadPath must be of type (['str']). Received type: %s" % type(
			    kwargs['downloadPath'])
	...
	def Overlay_setShowPaintRects(self, result):
		...
		assert isinstance(result, (bool,)
		    ), 'Argument result must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    result)
	...
	def Overlay_setShowDebugBorders(self, show):
		...
		assert isinstance(show, (bool,)
		    ), 'Argument show must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    show)
	...
	def Overlay_setSuspended(self, suspended):
		...
		assert isinstance(suspended, (bool,)
		    ), 'Argument suspended must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    suspended)
	...
	def Overlay_highlightRect(self, x, y, width, height, **kwargs):
		...
		assert isinstance(x, (int,)
		    ), 'Argument x must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    x)
		assert isinstance(y, (int,)
		    ), 'Argument y must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    y)
		assert isinstance(width, (int,)
		    ), 'Argument width must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    width)
	...
	def Emulation_setPageScaleFactor(self, pageScaleFactor):
		...
		assert isinstance(pageScaleFactor, (float, int)
		    ), 'Argument pageScaleFactor must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    pageScaleFactor)
	...
	def Emulation_setScriptExecutionDisabled(self, value):
		...
		assert isinstance(value, (bool,)
		    ), 'Argument value must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    value)
		subdom_funcs = self.synchronous_command(
	...
	def Emulation_setTouchEmulationEnabled(self, enabled, **kwargs):
		...
		if 'maxTouchPoints' in kwargs:
			assert isinstance(kwargs['maxTouchPoints'], (int,)
			    ), "Argument maxTouchPoints must be of type (['int']). Received type: %s" % type(
	...
	def Emulation_setEmulatedMedia(self, media):
		...
		assert isinstance(media, (str,)
		    ), 'Argument media must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    media)
	...
	def Emulation_setCPUThrottlingRate(self, rate):
		...
		assert isinstance(rate, (float, int)
		    ), 'Argument rate must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    rate)
	...
	def Emulation_setNavigatorOverrides(self, platform):
		...
		assert isinstance(platform, (str,)
		    ), 'Argument platform must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    platform)
	...
	def Security_handleCertificateError(self, eventId, action):
		...
		assert isinstance(eventId, (int,)
		    ), 'Argument eventId must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    eventId)
	...
	def Security_setOverrideCertificateErrors(self, override):
		...
		assert isinstance(override, (bool,)
		    ), 'Argument override must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    override)
		subdom_funcs = self.synchronous_command(
	...
	def Audits_getEncodedResponse(self, requestId, encoding, **kwargs):
		...
		assert isinstance(encoding, (str,)
		    ), 'Argument encoding must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    encoding)
		if 'quality' in kwargs:
			assert isinstance(kwargs['quality'], (float, int)
			    ), "Argument quality must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['quality'])
		if 'sizeOnly' in kwargs:
			assert isinstance(kwargs['sizeOnly'], (bool,)
			    ), "Argument sizeOnly must be of type (['bool']). Received type: %s" % type(
			    kwargs['sizeOnly'])
	...
	def Network_setUserAgentOverride(self, userAgent):
		...
		assert isinstance(userAgent, (str,)
		    ), 'Argument userAgent must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    userAgent)
	...
	def Network_setBlockedURLs(self, urls):
		...
		assert isinstance(urls, (list, tuple)
		    ), 'Argument urls must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
		    urls)
	...
	def Network_deleteCookies(self, name, **kwargs):
		...
		assert isinstance(name, (str,)
		    ), 'Argument name must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    name)
		if 'url' in kwargs:
	...
	def Network_setCookie(self, name, value, **kwargs):
		...
		assert isinstance(value, (str,)
		    ), 'Argument value must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    value)
		if 'url' in kwargs:
			assert isinstance(kwargs['url'], (str,)
			    ), "Argument url must be of type (['str']). Received type: %s" % type(
	...
	def Network_setCookies(self, cookies):
		...
		assert isinstance(cookies, (list, tuple)
		    ), 'Argument cookies must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
		    cookies)
	...
	def Network_emulateNetworkConditions(self, offline, latency,
		...
		assert isinstance(offline, (bool,)
		    ), 'Argument offline must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    offline)
		assert isinstance(latency, (float, int)
		    ), 'Argument latency must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    latency)
		assert isinstance(downloadThroughput, (float, int)
		    ), 'Argument downloadThroughput must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    downloadThroughput)
		assert isinstance(uploadThroughput, (float, int)
		    ), 'Argument uploadThroughput must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    uploadThroughput)
	...
	def Network_setCacheDisabled(self, cacheDisabled):
		...
		assert isinstance(cacheDisabled, (bool,)
		    ), 'Argument cacheDisabled must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    cacheDisabled)
	...
	def Network_setBypassServiceWorker(self, bypass):
		...
		assert isinstance(bypass, (bool,)
		    ), 'Argument bypass must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    bypass)
	...
	def Network_setDataSizeLimitsForTest(self, maxTotalSize, maxResourceSize):
		...
		assert isinstance(maxTotalSize, (int,)
		    ), 'Argument maxTotalSize must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    maxTotalSize)
		assert isinstance(maxResourceSize, (int,)
		    ), 'Argument maxResourceSize must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    maxResourceSize)
	...
	def Network_getCertificate(self, origin):
		...
		assert isinstance(origin, (str,)
		    ), 'Argument origin must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    origin)
	...
	def Network_continueInterceptedRequest(self, interceptionId, **kwargs):
		...
		if 'rawResponse' in kwargs:
			assert isinstance(kwargs['rawResponse'], (str,)
			    ), "Argument rawResponse must be of type (['str']). Received type: %s" % type(
			    kwargs['rawResponse'])
		if 'url' in kwargs:
			assert isinstance(kwargs['url'], (str,)
			    ), "Argument url must be of type (['str']). Received type: %s" % type(
		...
		if 'method' in kwargs:
			assert isinstance(kwargs['method'], (str,)
			    ), "Argument method must be of type (['str']). Received type: %s" % type(
			    kwargs['method'])
		if 'postData' in kwargs:
			assert isinstance(kwargs['postData'], (str,)
			    ), "Argument postData must be of type (['str']). Received type: %s" % type(
			    kwargs['postData'])
	...
	def IndexedDB_requestDatabaseNames(self, securityOrigin):
		...
		assert isinstance(securityOrigin, (str,)
		    ), 'Argument securityOrigin must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    securityOrigin)
	...
	def IndexedDB_requestDatabase(self, securityOrigin, databaseName):
		...
		assert isinstance(databaseName, (str,)
		    ), 'Argument databaseName must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    databaseName)
	...
	def IndexedDB_requestData(self, securityOrigin, databaseName,
		...
		assert isinstance(objectStoreName, (str,)
		    ), 'Argument objectStoreName must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    objectStoreName)
		assert isinstance(indexName, (str,)
		    ), 'Argument indexName must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    indexName)
		assert isinstance(skipCount, (int,)
		    ), 'Argument skipCount must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    skipCount)
		assert isinstance(pageSize, (int,)
		    ), 'Argument pageSize must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    pageSize)
		expected = ['keyRange']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
	...
	def CacheStorage_deleteEntry(self, cacheId, request):
		...
		assert isinstance(request, (str,)
		    ), 'Argument request must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    request)
	...
	def CacheStorage_requestCachedResponse(self, cacheId, requestURL):
		...
		assert isinstance(requestURL, (str,)
		    ), 'Argument requestURL must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    requestURL)
	...
	def DOMStorage_setDOMStorageItem(self, storageId, key, value):
		...
		assert isinstance(key, (str,)
		    ), 'Argument key must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    key)
		assert isinstance(value, (str,)
		    ), 'Argument value must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    value)
	...
	def DOM_querySelector(self, nodeId, selector):
		...
		assert isinstance(selector, (str,)
		    ), 'Argument selector must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    selector)
	...
	def DOM_setAttributesAsText(self, nodeId, text, **kwargs):
		...
		assert isinstance(text, (str,)
		    ), 'Argument text must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    text)
		if 'name' in kwargs:
	...
	def DOM_setOuterHTML(self, nodeId, outerHTML):
		...
		assert isinstance(outerHTML, (str,)
		    ), 'Argument outerHTML must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    outerHTML)
	...
	def DOM_getSearchResults(self, searchId, fromIndex, toIndex):
		...
		assert isinstance(searchId, (str,)
		    ), 'Argument searchId must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    searchId)
		assert isinstance(fromIndex, (int,)
		    ), 'Argument fromIndex must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    fromIndex)
		assert isinstance(toIndex, (int,)
		    ), 'Argument toIndex must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    toIndex)
	...
	def DOM_pushNodeByPathToFrontend(self, path):
		...
		assert isinstance(path, (str,)
		    ), 'Argument path must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    path)
	...
	def DOM_pushNodesByBackendIdsToFrontend(self, backendNodeIds):
		...
		assert isinstance(backendNodeIds, (list, tuple)
		    ), 'Argument backendNodeIds must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
		    backendNodeIds)
	...
	def DOM_setFileInputFiles(self, files, **kwargs):
		...
		assert isinstance(files, (list, tuple)
		    ), 'Argument files must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
		    files)
		expected = ['nodeId', 'backendNodeId', 'objectId']
		passed_keys = list(kwargs.keys())
		assert all([(key in expected) for key in passed_keys]
	...
	def CSS_setKeyframeKey(self, styleSheetId, range, keyText):
		...
		assert isinstance(keyText, (str,)
		    ), 'Argument keyText must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    keyText)
	...
	def CSS_setStyleTexts(self, edits):
		...
		assert isinstance(edits, (list, tuple)
		    ), 'Argument edits must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
		    edits)
	...
	def CSS_addRule(self, styleSheetId, ruleText, location):
		...
		assert isinstance(ruleText, (str,)
		    ), 'Argument ruleText must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    ruleText)
	...
	def CSS_forcePseudoState(self, nodeId, forcedPseudoClasses):
		...
		assert isinstance(forcedPseudoClasses, (list, tuple)
		    ), 'Argument forcedPseudoClasses must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
		    forcedPseudoClasses)
	...
	def CSS_setEffectivePropertyValueForNode(self, nodeId, propertyName, value):
		...
		assert isinstance(propertyName, (str,)
		    ), 'Argument propertyName must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    propertyName)
		assert isinstance(value, (str,)
		    ), 'Argument value must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    value)
	...
	def DOMSnapshot_getSnapshot(self, computedStyleWhitelist):
		...
		assert isinstance(computedStyleWhitelist, (list, tuple)
		    ), 'Argument computedStyleWhitelist must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
	...
	def DOMDebugger_setEventListenerBreakpoint(self, eventName, **kwargs):
		...
		assert isinstance(eventName, (str,)
		    ), 'Argument eventName must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    eventName)
	...
	def Target_setDiscoverTargets(self, discover):
		...
		assert isinstance(discover, (bool,)
		    ), 'Argument discover must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    discover)
	...
	def Target_setAutoAttach(self, autoAttach, waitForDebuggerOnStart):
		...
		assert isinstance(waitForDebuggerOnStart, (bool,)
		    ), 'Argument waitForDebuggerOnStart must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
	...
	def Target_setRemoteLocations(self, locations):
		...
		assert isinstance(locations, (list, tuple)
		    ), 'Argument locations must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
		    locations)
	...
	def Target_sendMessageToTarget(self, message, **kwargs):
		...
		assert isinstance(message, (str,)
		    ), 'Argument message must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    message)
	...
	def ServiceWorker_unregister(self, scopeURL):
		...
		assert isinstance(scopeURL, (str,)
		    ), 'Argument scopeURL must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    scopeURL)
	...
	def ServiceWorker_stopWorker(self, versionId):
		...
		assert isinstance(versionId, (str,)
		    ), 'Argument versionId must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    versionId)
	...
	def ServiceWorker_setForceUpdateOnPageLoad(self, forceUpdateOnPageLoad):
		...
		assert isinstance(forceUpdateOnPageLoad, (bool,)
		    ), 'Argument forceUpdateOnPageLoad must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
	...
	def ServiceWorker_deliverPushMessage(self, origin, registrationId, data):
		...
		assert isinstance(registrationId, (str,)
		    ), 'Argument registrationId must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    registrationId)
		assert isinstance(data, (str,)
		    ), 'Argument data must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    data)
	...
	def ServiceWorker_dispatchSyncEvent(self, origin, registrationId, tag,
		...
		assert isinstance(tag, (str,)
		    ), 'Argument tag must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    tag)
		assert isinstance(lastChance, (bool,)
		    ), 'Argument lastChance must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    lastChance)
	...
	def Input_setIgnoreInputEvents(self, ignore):
		...
		assert isinstance(ignore, (bool,)
		    ), 'Argument ignore must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    ignore)
	...
	def Input_dispatchKeyEvent(self, type, **kwargs):
		...
		assert isinstance(type, (str,)
		    ), 'Argument type must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    type)
	...
	def Input_dispatchMouseEvent(self, type, x, y, **kwargs):
		...
		assert isinstance(x, (float, int)
		    ), 'Argument x must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    x)
		assert isinstance(y, (float, int)
		    ), 'Argument y must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    y)
		if 'modifiers' in kwargs:
			assert isinstance(kwargs['modifiers'], (int,)
			    ), "Argument modifiers must be of type (['int']). Received type: %s" % type(
	...
	def Input_dispatchTouchEvent(self, type, touchPoints, **kwargs):
		...
		assert isinstance(touchPoints, (list, tuple)
		    ), 'Argument touchPoints must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
		    touchPoints)
		if 'modifiers' in kwargs:
			assert isinstance(kwargs['modifiers'], (int,)
			    ), "Argument modifiers must be of type (['int']). Received type: %s" % type(
	...
	def Input_emulateTouchFromMouseEvent(self, type, x, y, timestamp, button,
	    **kwargs):
		...
		assert isinstance(button, (str,)
		    ), 'Argument button must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    button)
		if 'deltaX' in kwargs:
			assert isinstance(kwargs['deltaX'], (float, int)
			    ), "Argument deltaX must be of type (['float', 'int']). Received type: %s" % type(
	...
	def Input_synthesizePinchGesture(self, x, y, scaleFactor, **kwargs):
		...
		assert isinstance(scaleFactor, (float, int)
		    ), 'Argument scaleFactor must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    scaleFactor)
	...
	def Input_synthesizeScrollGesture(self, x, y, **kwargs):
		...
		if 'xDistance' in kwargs:
			assert isinstance(kwargs['xDistance'], (float, int)
			    ), "Argument xDistance must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['xDistance'])
		if 'yDistance' in kwargs:
			assert isinstance(kwargs['yDistance'], (float, int)
			    ), "Argument yDistance must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['yDistance'])
		if 'xOverscroll' in kwargs:
			assert isinstance(kwargs['xOverscroll'], (float, int)
			    ), "Argument xOverscroll must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['xOverscroll'])
		if 'yOverscroll' in kwargs:
			assert isinstance(kwargs['yOverscroll'], (float, int)
			    ), "Argument yOverscroll must be of type (['float', 'int']). Received type: %s" % type(
			    kwargs['yOverscroll'])
	...
	def LayerTree_loadSnapshot(self, tiles):
		...
		assert isinstance(tiles, (list, tuple)
		    ), 'Argument tiles must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
		    tiles)
	...
	def Tracing_recordClockSyncMarker(self, syncId):
		...
		assert isinstance(syncId, (str,)
		    ), 'Argument syncId must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    syncId)
	...
	def Animation_setPlaybackRate(self, playbackRate):
		...
		assert isinstance(playbackRate, (float, int)
		    ), 'Argument playbackRate must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    playbackRate)
	...
	def Animation_getCurrentTime(self, id):
		...
		assert isinstance(id, (str,)
		    ), 'Argument id must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    id)
	...
	def Animation_setPaused(self, animations, paused):
		...
		assert isinstance(animations, (list, tuple)
		    ), 'Argument animations must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
		    animations)
		assert isinstance(paused, (bool,)
		    ), 'Argument paused must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    paused)
	...
	def Animation_setTiming(self, animationId, duration, delay):
		...
		assert isinstance(animationId, (str,)
		    ), 'Argument animationId must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    animationId)
		assert isinstance(duration, (float, int)
		    ), 'Argument duration must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    duration)
		assert isinstance(delay, (float, int)
		    ), 'Argument delay must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    delay)
	...
	def Animation_seekAnimations(self, animations, currentTime):
		...
		assert isinstance(currentTime, (float, int)
		    ), 'Argument currentTime must be of type (<_ast.Tuple object at 0x7fed5c80cdd8>). Received type: %s' % type(
		    currentTime)
	...
	def Storage_clearDataForOrigin(self, origin, storageTypes):
		...
		assert isinstance(storageTypes, (str,)
		    ), 'Argument storageTypes must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    storageTypes)
	...
	def Log_startViolationsReport(self, config):
		...
		assert isinstance(config, (list, tuple)
		    ), 'Argument config must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
		    config)
	...
	def Tethering_bind(self, port):
		...
		assert isinstance(port, (int,)
		    ), 'Argument port must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    port)
	...
	def Runtime_evaluate(self, expression, **kwargs):
		...
		assert isinstance(expression, (str,)
		    ), 'Argument expression must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    expression)
		if 'objectGroup' in kwargs:
			assert isinstance(kwargs['objectGroup'], (str,)
			    ), "Argument objectGroup must be of type (['str']). Received type: %s" % type(
	...
	def Runtime_callFunctionOn(self, functionDeclaration, **kwargs):
		...
		assert isinstance(functionDeclaration, (str,)
		    ), 'Argument functionDeclaration must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    functionDeclaration)
	...
	def Runtime_releaseObjectGroup(self, objectGroup):
		...
		assert isinstance(objectGroup, (str,)
		    ), 'Argument objectGroup must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    objectGroup)
	...
	def Runtime_compileScript(self, expression, sourceURL, persistScript, **kwargs
		...
		assert isinstance(sourceURL, (str,)
		    ), 'Argument sourceURL must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    sourceURL)
		assert isinstance(persistScript, (bool,)
		    ), 'Argument persistScript must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    persistScript)
	...
	def Debugger_setBreakpointsActive(self, active):
		...
		assert isinstance(active, (bool,)
		    ), 'Argument active must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    active)
	...
	def Debugger_setSkipAllPauses(self, skip):
		...
		assert isinstance(skip, (bool,)
		    ), 'Argument skip must be of type (<_ast.Tuple object at 0x7fed5c80cba8>). Received type: %s' % type(
		    skip)
	...
	def Debugger_setBreakpointByUrl(self, lineNumber, **kwargs):
		...
		assert isinstance(lineNumber, (int,)
		    ), 'Argument lineNumber must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    lineNumber)
		if 'url' in kwargs:
			assert isinstance(kwargs['url'], (str,)
			    ), "Argument url must be of type (['str']). Received type: %s" % type(
	...
	def Debugger_continueToLocation(self, location, **kwargs):
		...
		if 'targetCallFrames' in kwargs:
			assert isinstance(kwargs['targetCallFrames'], (str,)
			    ), "Argument targetCallFrames must be of type (['str']). Received type: %s" % type(
	...
	def Debugger_setPauseOnExceptions(self, state):
		...
		assert isinstance(state, (str,)
		    ), 'Argument state must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    state)
	...
	def Debugger_setVariableValue(self, scopeNumber, variableName, newValue,
		...
		assert isinstance(scopeNumber, (int,)
		    ), 'Argument scopeNumber must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    scopeNumber)
		assert isinstance(variableName, (str,)
		    ), 'Argument variableName must be of type (<_ast.Tuple object at 0x7fed5c80ceb8>). Received type: %s' % type(
		    variableName)
	...
	def Debugger_setAsyncCallStackDepth(self, maxDepth):
		...
		assert isinstance(maxDepth, (int,)
		    ), 'Argument maxDepth must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    maxDepth)
	...
	def Debugger_setBlackboxPatterns(self, patterns):
		...
		assert isinstance(patterns, (list, tuple)
		    ), 'Argument patterns must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
		    patterns)
	...
	def Debugger_setBlackboxedRanges(self, scriptId, positions):
		...
		assert isinstance(positions, (list, tuple)
		    ), 'Argument positions must be of type (<_ast.Tuple object at 0x7fed5c80cac8>). Received type: %s' % type(
		    positions)
	...
	def Profiler_setSamplingInterval(self, interval):
		...
		assert isinstance(interval, (int,)
		    ), 'Argument interval must be of type (<_ast.Tuple object at 0x7fed5c80cc88>). Received type: %s' % type(
		    interval)
	...
	def Profiler_startPreciseCoverage(self, **kwargs):
		...
		if 'detailed' in kwargs:
			assert isinstance(kwargs['detailed'], (bool,)
			    ), "Argument detailed must be of type (['bool']). Received type: %s" % type(
			    kwargs['detailed'])
